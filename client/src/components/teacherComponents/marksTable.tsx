...
function TeacherMarksTable({ marksData, handleEditMarks, handleDeleteMarks, startIndex }: Props) {
    return (
        <div >
                ...
                <tbody>
                    {marksData.length === 0 ? (
                        ...
                        <tr key={mark._id}>
                            ...
                            <td className="border border-gray-400 p-3">{mark.subjectId?.name ?? "Student Deleted"}</td>
